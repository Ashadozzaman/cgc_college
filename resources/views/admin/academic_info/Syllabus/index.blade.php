...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">Syllabus List</h4>
        ...
        <div class="card">
            <div class="card-body">
                <div class="user-title row">
                    <h4 class="col-md-10">Syllabus List</h4>
                    <a href="{{route('syllabus.create')}}" class="btn btn-primary btn-sm col-md-2"><i class="fa fa-plus"></i>Add Syllabus</a>
                </div>
                <br>
                @include('_message')
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex;">
                                    <a href="{{route('syllabus.edit',$syllabus->id)}}" class="fa fa-edit"></a>
