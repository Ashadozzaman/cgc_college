...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">Create exams List</h4>
        ...
        <div class="card">
            <div class="card-body">
                <div class="user-title row">
                    <h4 class="col-md-10">Create exams List</h4>
                    <a href="{{route('create_exam.create')}}" class="btn btn-primary btn-sm col-md-2"><i class="fa fa-plus"></i>Create Exam</a>
                </div>
                <br>
                @include('_message')
                <table id="kt-table" class="kt-table table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        @foreach($create_exams as $key=> $create_exam)
                        <tr>
                            <td>{{$key+1}}</td>
                            ...
                            <td>
                                <div style="display: flex;">
                                    <a href="{{route('create_exam.edit',$create_exam->id)}}" class="fa fa-edit"></a>
