...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">Gallery List</h4>
        ...
        <div class="card">
            <div class="card-body">
                <div class="user-title row">
                    <h4 class="col-md-10">Gallery List</h4>
                    <a href="{{route('gallery.create')}}" class="btn btn-primary btn-sm col-md-2"><i class="fa fa-plus"></i>Add gallery</a>
                </div>
                <br>
                @include('_message')
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$key+1}}</td>
                            <td width="20%">
                                <img src="{{asset('assets/admin/images/gallery/')}}/{{$gallery->image}}" alt="gallery image" width="50%">
                            </td>
                            ...
                            <td>
                                <div style="display: flex;">
                                    <a href="{{route('gallery.edit',$gallery->id)}}" class="fa fa-edit"></a>
