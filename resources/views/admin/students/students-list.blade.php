...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">Students List</h4>
        ...
        <div class="card">
            <div class="card-body">
                <div class="user-title row">
                    <h4 class="col-md-10">Students List</h4>
                    {{-- <a href="" class="btn btn-primary btn-sm col-md-2"><i class="fa fa-plus"></i>Add Student</a> --}}
                </div>
                <br>
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                    	@foreach($register_students as $key=>$user)
                        <tr>
                            <td>{{$key+1}}</td>
                            ...
                            <td>{{$user->details->ssc_reg}}</td>
                            <td>{{$user->education_year}}</td>
                            <td>
                                <div style="display: flex;">
                                    <a href="{{route('edit.student',$user->id)}}" class="fa fa-edit"></a>
